# Form implementation generated from reading ui file 'D:\2025_2026\se1\machine\ML_K23416\MLBAProject\UI\MainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_gender.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPurchaseRatesByGender.setIcon(icon1)
        self.pushButtonPurchaseRatesByGender.setIconSize(QtCore.QSize(20, 20))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_age.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPurchaseRatesByAgeGroup.setIcon(icon2)
        self.pushButtonPurchaseRatesByAgeGroup.setIconSize(QtCore.QSize(20, 20))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_category.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPurchaseCountingByCategory.setIcon(icon3)
        self.pushButtonPurchaseCountingByCategory.setIconSize(QtCore.QSize(20, 20))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_value.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPurchaseValueByCategory.setIcon(icon4)
        self.pushButtonPurchaseValueByCategory.setIconSize(QtCore.QSize(20, 20))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_cat_gen.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPurchaseByCategoryAndGender.setIcon(icon5)
        self.pushButtonPurchaseByCategoryAndGender.setIconSize(QtCore.QSize(20, 20))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_money.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPaymentMethod.setIcon(icon6)
        self.pushButtonPaymentMethod.setIconSize(QtCore.QSize(20, 20))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_cart.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPurchaseRatesByShoppingMall.setIcon(icon7)
        self.pushButtonPurchaseRatesByShoppingMall.setIconSize(QtCore.QSize(20, 20))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_gender_2.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonProductSpendingByGender.setIcon(icon8)
        self.pushButtonProductSpendingByGender.setIconSize(QtCore.QSize(20, 20))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/690123.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonPurchaseFrequenceByAge.setIcon(icon9)
        self.pushButtonPurchaseFrequenceByAge.setIconSize(QtCore.QSize(20, 20))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("D:\\2025_2026\\se1\\machine\\ML_K23416\\MLBAProject\\UI\\../Images/ic_connect.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionConnection.setIcon(icon10)
